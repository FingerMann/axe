...
"%s corrupt. Try using the wallet tool axe-wallet to salvage or restoring a "
"backup."),
QT_TRANSLATE_NOOP("axe-core", ""
...
QT_TRANSLATE_NOOP("axe-core", "%s can't be lower than %s"),
QT_TRANSLATE_NOOP("axe-core", "%s failed"),
QT_TRANSLATE_NOOP("axe-core", "%s is idle."),
QT_TRANSLATE_NOOP("axe-core", "%s is not a valid backup folder!"),
QT_TRANSLATE_NOOP("axe-core", "%s is only allowed with a single wallet file"),
QT_TRANSLATE_NOOP("axe-core", "%s is set very high!"),
QT_TRANSLATE_NOOP("axe-core", "%s request incomplete:"),
...
QT_TRANSLATE_NOOP("axe-core", "A fatal internal error occurred, see debug.log for details"),
...
QT_TRANSLATE_NOOP("axe-core", "Cannot set -peerblockfilters without -blockfilterindex."),
QT_TRANSLATE_NOOP("axe-core", "Cannot write to data directory '%s'; check permissions."),
QT_TRANSLATE_NOOP("axe-core", "Change index out of range"),
QT_TRANSLATE_NOOP("axe-core", "Collateral not valid."),
QT_TRANSLATE_NOOP("axe-core", "Config setting for %s only applied on %s network when in [%s] section."),
QT_TRANSLATE_NOOP("axe-core", "Copyright (C)"),
QT_TRANSLATE_NOOP("axe-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("axe-core", "Could not find asmap file %s"),
QT_TRANSLATE_NOOP("axe-core", "Could not parse asmap file %s"),
QT_TRANSLATE_NOOP("axe-core", "Disk space is too low!"),
...
QT_TRANSLATE_NOOP("axe-core", "Error loading %s: Private keys can only be disabled during creation"),
...
QT_TRANSLATE_NOOP("axe-core", "Error: Disk space is low for %s"),
QT_TRANSLATE_NOOP("axe-core", "Error: failed to add socket to epollfd (epoll_ctl returned error %s)"),
QT_TRANSLATE_NOOP("axe-core", "Error: failed to add socket to kqueuefd (kevent returned error %s)"),
QT_TRANSLATE_NOOP("axe-core", "Exceeded max tries."),
QT_TRANSLATE_NOOP("axe-core", "Failed to clear fulfilled requests cache at %s"),
QT_TRANSLATE_NOOP("axe-core", "Failed to clear governance cache at %s"),
QT_TRANSLATE_NOOP("axe-core", "Failed to clear masternode cache at %s"),
...
QT_TRANSLATE_NOOP("axe-core", "Failed to load fulfilled requests cache from %s"),
QT_TRANSLATE_NOOP("axe-core", "Failed to load governance cache from %s"),
QT_TRANSLATE_NOOP("axe-core", "Failed to load masternode cache from %s"),
QT_TRANSLATE_NOOP("axe-core", "Failed to load sporks cache from %s"),
...
QT_TRANSLATE_NOOP("axe-core", "Incorrect -rescan mode, falling back to default value"),
...
QT_TRANSLATE_NOOP("axe-core", "Invalid P2P permission: '%s'"),
...
QT_TRANSLATE_NOOP("axe-core", "Last queue was created too recently."),
QT_TRANSLATE_NOOP("axe-core", "Last successful action was too recent."),
...
QT_TRANSLATE_NOOP("axe-core", "Prune mode is incompatible with -blockfilterindex."),
...
QT_TRANSLATE_NOOP("axe-core", "SQLiteDatabase: Failed to execute statement to verify database: %s"),
QT_TRANSLATE_NOOP("axe-core", "SQLiteDatabase: Failed to prepare statement to verify database: %s"),
QT_TRANSLATE_NOOP("axe-core", "SQLiteDatabase: Failed to read database verification error: %s"),
QT_TRANSLATE_NOOP("axe-core", "SQLiteDatabase: Unexpected application id. Expected %u, got %u"),
QT_TRANSLATE_NOOP("axe-core", "Section [%s] is not recognized."),
...
QT_TRANSLATE_NOOP("axe-core", "Specified blocks directory \"%s\" does not exist."),
...
QT_TRANSLATE_NOOP("axe-core", "The specified config file %s does not exist\n"),
...
QT_TRANSLATE_NOOP("axe-core", "Unable to create the PID file '%s': %s"),
QT_TRANSLATE_NOOP("axe-core", "Unable to generate initial keys"),
QT_TRANSLATE_NOOP("axe-core", "Unable to locate enough mixed funds for this transaction."),
QT_TRANSLATE_NOOP("axe-core", "Unable to locate enough non-denominated funds for this transaction."),
...
QT_TRANSLATE_NOOP("axe-core", "Unknown -blockfilterindex value %s."),
...
QT_TRANSLATE_NOOP("axe-core", "Upgrading txindex database"),
...
QT_TRANSLATE_NOOP("axe-core", "Warning: can't use %s and %s together, will prefer %s"),
QT_TRANSLATE_NOOP("axe-core", "Warning: incorrect parameter %s, path must exist! Using default path."),
