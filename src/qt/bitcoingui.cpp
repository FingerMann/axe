...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Axe address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Axe address").arg(strCoinJoinName));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr("&Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and axe: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a axe: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Axe command-line options").arg(PACKAGE_NAME));
