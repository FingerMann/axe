...
//! Interface for the src/evo part of a axe node (axed process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a axe node (axed process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a axe node (axed process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a axe node (axed process).
...
//! Top-level interface for a axe node (axed process).
class Node
{
public:
    virtual ~Node() {}
