...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " axe-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  axe-tx [options] <hex-tx> [commands]  Update hex-encoded axe transaction\n" +
            "or:     axe-tx [options] -create [commands]   Create hex-encoded axe transaction\n" +
            "\n";
