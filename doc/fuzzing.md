# Fuzzing Axe Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Axe Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/axerunners/axe/blob/develop/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/axerunners/axe/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/axerunners/axe/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/axerunners/axe/tree/develop/src/test/fuzz).
...
Every single pull request submitted against the Axe Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Axe Core more robust.
...
with certain assembly code from Axe Core's code. See [developer notes on sanitizers](https://github.com/axerunners/axe/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing Axe Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Axe Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing Axe Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Axe Core using [Honggfuzz](https://github.com/google/honggfuzz):
