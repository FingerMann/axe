# Support for Output Descriptors in Axe Core

Since Axe Core v0.17, there is support for Output Descriptors. This is a
...
existing Axe Core wallets, a convenience function `combo` is
...
All RPCs in Axe Core will include the checksum in their output. Only
