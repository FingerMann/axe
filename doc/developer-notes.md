...
- [Development guidelines](#development-guidelines)
    - [General Axe Core](#general-axe-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Axe Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Axe Core is a multi-threaded application, and deadlocks or other
...
To profile a running axed process for 60 seconds, you could use an
invocation of `perf record` like this:

```sh
$ perf record \
    -g --call-graph dwarf --per-thread -F 140 \
    -p `pgrep axed` -- sleep 60
```
...
Axe Core can be compiled with various "sanitizers" enabled, which add
